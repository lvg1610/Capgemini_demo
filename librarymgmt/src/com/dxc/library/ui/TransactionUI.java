...
public class TransactionUI 
{
    ...
    public static String issueBook(Scanner sc)
    {
         ...
         if(m!=null)
         {
        	 ...
        	 return "Entered Invalid Member Id ";
    }
    public static String returnBook(Scanner sc)
    {
    	...
    	{
    		return bsDao.modifyBookStatus('r', bookId) ? "Book Returned Successfully" : "Book Return Failed";
    	}
    	return "Book Return Transaction Cannot be Updated";
    }
}
